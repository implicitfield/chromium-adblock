...
#include "components/brave_shields/content/browser/filter_list_service.h"
...
#include "components/brave_shields/core/common/filter_list.mojom-forward.h"
#include "components/brave_shields/core/common/filter_list.mojom-shared.h"
