...
#include "components/brave_shields/content/browser/domain_block_navigation_throttle.h"
...
#include "components/brave_shields/content/browser/domain_block_controller_client.h"
#include "components/brave_shields/content/browser/domain_block_page.h"
